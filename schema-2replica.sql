...
CREATE TABLE IF NOT EXISTS test.ontime_schema
(
    Year UInt16,
    Quarter UInt8,
    Month UInt8,
 ...
 */
CREATE TABLE IF NOT EXISTS r0.ontime AS test.ontime_schema
 ...
 * This replica is {replica}
 */
CREATE TABLE IF NOT EXISTS r1.ontime AS test.ontime_schema
ENGINE = ReplicatedMergeTree(
...
CREATE TABLE IF NOT EXISTS test.ontime AS test.ontime_schema
ENGINE = Distributed(
    'ontime_cluster',
    '',
    ontime,
